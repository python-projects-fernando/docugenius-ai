...
from backend.interfaces.api.v1.user.document_field_user_routes import router as user_document_field_router
import os
...
app.include_router(user_document_field_router, prefix="/api/v1/user")
